...
import React, { useState } from "react";
import axios from "axios";
import TablePagination from "@mui/material/TablePagination"; // <-- MUI pagination
  ...
  return (
    <div className="bg-gray-200 py-4">
      <div className="mt-8 container">
            ...
            <tbody>
              {paginatedItems.map((c, index) => (
                <tr key={c._id}>
                  ...
                  <td className="p-2 border">{page * rowsPerPage + index + 1}</td>
                  <td className="p-2 border">{c.name}</td>
                  <td className="p-2 border">{c.phone}</td>
                  <td className="p-2 border">{c.email}</td>
                  <td className="p-2 border">{c.experience}</td>
        ...
        <div className="mt-4 flex justify-center w-[80vw]">
          <TablePagination
            component="div"
